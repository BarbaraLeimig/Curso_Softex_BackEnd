...
function calculator() {
    ...
    Digite o numero da operacao que deseja realizar: `);
        ...
        // Verificar se o usuário deseja realizar um novo cálculo. Caso não, encerrar o programa
        let answer = readline.question("\nDeseja realizar um novo calculo? Digite 'sim' para continuar ou qualquer outra tecla para sair.\n")
